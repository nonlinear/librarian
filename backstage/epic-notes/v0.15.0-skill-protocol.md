...
:root {
  ...
  --developed-notes-bg: #FFE082;
  --developed-notes-border: #F57C00;
  --partial-bg: #E1BEE7;
...
.swatch-bg-node { background-color: var(--node-bg); width: 40px; }
.swatch-border-node { background-color: var(--node-border); width: 40px; }
.swatch-bg-approved { background-color: var(--approved-bg); width: 40px; }
.swatch-border-approved { background-color: var(--approved-border); width: 40px; }
.swatch-bg-blocker { background-color: var(--blocker-bg); width: 40px; }
.swatch-border-blocker { background-color: var(--blocker-border); width: 40px; }
.swatch-bg-developed { background-color: var(--developed-bg); width: 40px; }
.swatch-border-developed { background-color: var(--developed-border); width: 40px; }
.swatch-bg-developed-notes { background-color: var(--developed-notes-bg); width: 40px; }
.swatch-border-developed-notes { background-color: var(--developed-notes-border); width: 40px; }
.swatch-bg-partial { background-color: var(--partial-bg); width: 40px; }
.swatch-border-partial { background-color: var(--partial-border); width: 40px; }
</style>

```mermaid
flowchart TB
    TRIGGER(["🎤 Trigger + context"]):::developed
    TRIGGER --> METADATA(["👷 Load metadata _1_"]):::default
    METADATA --> CHECK{"👷 Metadata exists?"}:::default
    
    CHECK -->|No| ERROR(["🎤 🤚 No metadata found:<br>Run librarian index _5_"]):::approved
    CHECK -->|Yes| INFER{"🎤 Infer scope? _2_"}:::blocker
    
    INFER -->|confidence lower than 75%| CLARIFY(["🎤 🤚 Say it again? _5_"]):::approved
    INFER -->|confidence higher than 75%| BUILD(["👷 Build command _3_"]):::developed
    
    BUILD --> CHECK_SYSTEM{"⚙️ System working?"}:::developed
    ...
    CHECK_RESULTS -->|No| EMPTY(["🎤 🤚 No results found _5_"]):::developed
    CHECK_RESULTS -->|Yes| FORMAT(["🎤 Format output _4_"]):::developed
...
<table>
  ...
  <tr>
    <td>.node</td>
    <td class="swatch-bg-node"></td>
    <td class="swatch-border-node"></td>
    <td>No agreement yet. Backlog, not discussed, not approved.</td>
  </tr>
  <tr>
    <td>.approved</td>
    <td class="swatch-bg-approved"></td>
    <td class="swatch-border-approved"></td>
    <td>Agreed by all stakeholders, ready for development. Sometimes has notes.</td>
  </tr>
  <tr>
    <td>.blocker</td>
    <td class="swatch-bg-blocker"></td>
    <td class="swatch-border-blocker"></td>
    <td>Either needs discussion to agree, OR failed implementation. <strong>Always with numbered note.</strong></td>
  </tr>
  <tr>
    <td>.developed</td>
    <td class="swatch-bg-developed"></td>
    <td class="swatch-border-developed"></td>
    <td>Agreed and implemented. Ready for testing.</td>
  </tr>
  <tr>
    <td>.developed-notes</td>
    <td class="swatch-bg-developed-notes"></td>
    <td class="swatch-border-developed-notes"></td>
    <td>Agreed and implemented, but developer (AI) made decisions that warrant discussion.</td>
  </tr>
  <tr>
    <td>.partial</td>
    <td class="swatch-bg-partial"></td>
    <td class="swatch-border-partial"></td>
