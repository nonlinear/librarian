...
flowchart TB
    ...
    %% CSS classes must be defined in Mermaid (GitHub limitation)
    classDef default fill:#f5f5f5,stroke:#999,stroke-width:2px,color:#000
    classDef approved fill:#C8E6C9,stroke:#388E3C,stroke-width:2px,color:#000
    classDef blocker fill:#FFCDD2,stroke:#D32F2F,stroke-width:2px,color:#000
    classDef developed fill:#BBDEFB,stroke:#1976D2,stroke-width:2px,color:#000
    classDef developed+ fill:#FFE082,stroke:#F57C00,stroke-width:2px,color:#000
    classDef partial fill:#E1BEE7,stroke:#7B1FA2,stroke-width:2px,color:#000
```
