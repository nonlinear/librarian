...
| ⚫ Gray | Not started | `#9E9E9E` | Backlog, low priority |
| 🟨 Yellow | Approved/In Progress | `#FFC107` | Agreed but not executed |
| 🔴 Red | Broken/Blocked | `#f44336` | Needs fix or decision (numbered note) |
| 🔵 Blue | Exists/Working | `#2196F3` | Component implemented and functional |
