...
.arrow.approved {
  background-color: var(--approved-border);
}

.arrow.blocker {
  background-color: var(--blocker-border);
}

.arrow.developed {
  background-color: var(--developed-border);
}

.arrow.developed-plus {
  background-color: var(--developed-plus-border);
}

.arrow.partial {
  background-color: var(--partial-border);
}
</style>
...
|---|------|-------|------|------------------------|
| 1 | <span class="node default">█</span> | <span class="arrow default">█</span> | **default** | No agreement yet. Backlog, not discussed, not approved. |
| 2 | <span class="node approved">█</span> | <span class="arrow approved">█</span> | **approved** | Agreed by all stakeholders, ready for development. Sometimes has notes. |
| 3 | <span class="node blocker">█</span> | <span class="arrow blocker">█</span> | **blocker** | Either needs discussion to agree, OR failed implementation. **Always with numbered note.** |
| 4 | <span class="node developed">█</span> | <span class="arrow developed">█</span> | **developed** | Agreed and implemented. Ready for testing. |
| 5 | <span class="node developed-plus">█</span> | <span class="arrow developed-plus">█</span> | **developed+** | Agreed and implemented, but developer (AI) made decisions that warrant discussion. |
| 6 | <span class="node partial">█</span> | <span class="arrow partial">█</span> | **partial** | Node works, but some paths (arrows) fail. **Use arrow colors to show which paths work vs fail.** |
