...
flowchart TD
    ...
    style USER fill:#E0E0E0,stroke:#9E9E9E,color:#000,font-weight:bold
...
### 5️⃣ Format Output (needs clarification)
...
- Kavita deep-links (paragraph/page precision) → v1.4.0 "Reader Integration & Source Granularity"?
- Context snippets → Same epic or separate?
