...
flowchart TB
    ...
    classDef approved fill:#4caf50,stroke:#2e7d32,color:#fff
    classDef blocker fill:#f44336,stroke:#c62828,color:#fff
    classDef developed fill:#ff9800,stroke:#e65100,color:#fff
```
...
flowchart TB
    ...
    INFER -->|≥ 75%| BUILD["👷 Build command"]:::red
...
- 🔴 Red = Implemented, tested, BROKEN (see notes)
...
**🟠 ORANGE (7 nodes - need AI session):**
- TRIGGER - Conversational activation
- INFER - Scope inference (confidence >75%)
- CLARIFY - Low confidence hard stop
- FORMAT - Emoji citations + synthesis
- RESPONSE - Final user output
- BROKEN - System failure hard stop
- EMPTY - No results hard stop (unlikely - research.py always returns K results)
...
**Phase 2 remaining:**
- [ ] **Fix --book flag** (Node BUILD 🔴 → 🟢)
  - Decision: Option A (wrapper auto-detect) or Option B (research.py refactor)?
  - Implementation: 1-2 hours
  - Testing: Book search end-to-end

**Phase 3 (after Phase 2 complete):**
- [ ] Frontmatter (emoji, deps, install)
- [ ] Pre-trigger flow design
- [ ] AGENTS.md integration
- [ ] Expand SKILL.md examples

**Phase 4 (validation):**
- [ ] AI session testing (ORANGE nodes)
- [ ] Real user testing
- [ ] Document edge cases
...
**Current state:**
- 8/15 nodes GREEN (53%)
- 7/15 nodes ORANGE (47% - need AI test)
- 1/15 nodes RED (7% - fixable bug)

**Target state (Phase 2 done):**
- 9/15 nodes GREEN (60%)
- 6/15 nodes ORANGE (40%)
- 0/15 nodes RED
