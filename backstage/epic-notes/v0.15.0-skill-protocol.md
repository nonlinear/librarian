...
flowchart TB
    ...
    style TRIGGER fill:#FFFFFF,stroke:#FFB74D,stroke-width:2px,color:#000
    style METADATA fill:#FFFFFF,stroke:#9E9E9E,stroke-width:2px,color:#000
    style INFER fill:#FFFFFF,stroke:#E57373,stroke-width:2px,color:#000
    style CLARIFY fill:#FFFFFF,stroke:#FFB74D,stroke-width:2px,color:#000
    style BUILD fill:#FFFFFF,stroke:#64B5F6,stroke-width:2px,color:#000
    style EXEC fill:#FFFFFF,stroke:#64B5F6,stroke-width:2px,color:#000
    style JSON fill:#FFFFFF,stroke:#64B5F6,stroke-width:2px,color:#000
    style FORMAT fill:#FFFFFF,stroke:#64B5F6,stroke-width:2px,color:#000
    style RESPONSE fill:#FFFFFF,stroke:#64B5F6,stroke-width:2px,color:#000
    style CHECK fill:#FFFFFF,stroke:#9E9E9E,stroke-width:2px,color:#000
    style ERROR fill:#FFFFFF,stroke:#FFB74D,stroke-width:2px,color:#000
    style CHECK_SYSTEM fill:#FFFFFF,stroke:#64B5F6,stroke-width:2px,color:#000
    style BROKEN fill:#FFFFFF,stroke:#FFB74D,stroke-width:2px,color:#000
    style CHECK_RESULTS fill:#FFFFFF,stroke:#64B5F6,stroke-width:2px,color:#000
    style EMPTY fill:#FFFFFF,stroke:#64B5F6,stroke-width:2px,color:#000
```
