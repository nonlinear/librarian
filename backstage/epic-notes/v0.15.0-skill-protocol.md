...
flowchart TB
    ...
    INFER -->|confidence lower than 75%| CLARIFY["🎤 🤚 Say it again? _5_"]
    INFER -->|confidence higher than 75%| BUILD["👷 Build command _3_"]
    
    BUILD --> CHECK_SYSTEM{"⚙️ System working?"}
    
    CHECK_SYSTEM -->|No| BROKEN["🎤 🤚 System is broken _5_"]
    CHECK_SYSTEM -->|Yes| EXEC["⚙️ Run python script with flags"]
