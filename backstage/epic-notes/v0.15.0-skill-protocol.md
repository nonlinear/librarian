...
/* Catch ALL children of node groups */
g.node > * {
  stroke-width: 2px !important;
}

/* Catch ALL children of node groups - MOST AGGRESSIVE */
g.node.default path:not(.edgePath path),
g.node.default rect:not(.edgeLabel rect) {
  fill: var(--node-bg) !important;
  stroke: var(--node-border) !important;
}

g.node.approved path:not(.edgePath path),
g.node.approved rect:not(.edgeLabel rect) {
  fill: var(--approved-bg) !important;
  stroke: var(--approved-border) !important;
}

g.node.blocker path:not(.edgePath path),
g.node.blocker rect:not(.edgeLabel rect) {
  fill: var(--blocker-bg) !important;
  stroke: var(--blocker-border) !important;
}

g.node.developed path:not(.edgePath path),
g.node.developed rect:not(.edgeLabel rect) {
  fill: var(--developed-bg) !important;
  stroke: var(--developed-border) !important;
}
...
<table>
  ...
  <tr>
    <td>.node</td>
    <td style="background-color: var(--node-bg); width: 40px;"></td>
    <td style="background-color: var(--node-border); width: 40px;"></td>
    <td>No agreement yet. Backlog, not discussed, not approved.</td>
  </tr>
  <tr>
    <td>.approved</td>
    <td style="background-color: var(--approved-bg); width: 40px;"></td>
    <td style="background-color: var(--approved-border); width: 40px;"></td>
    <td>Agreed by all stakeholders, ready for development. Sometimes has notes.</td>
  </tr>
  <tr>
    <td>.blocker</td>
    <td style="background-color: var(--blocker-bg); width: 40px;"></td>
    <td style="background-color: var(--blocker-border); width: 40px;"></td>
    <td>Either needs discussion to agree, OR failed implementation. <strong>Always with numbered note.</strong></td>
  </tr>
  <tr>
    <td>.developed</td>
    <td style="background-color: var(--developed-bg); width: 40px;"></td>
    <td style="background-color: var(--developed-border); width: 40px;"></td>
    <td>Agreed and implemented. Ready for testing.</td>
  </tr>
  <tr>
    <td>.developed-notes</td>
    <td style="background-color: var(--developed-notes-bg); width: 40px;"></td>
    <td style="background-color: var(--developed-notes-border); width: 40px;"></td>
    <td>Agreed and implemented, but developer (AI) made decisions that warrant discussion.</td>
  </tr>
  <tr>
    <td>.partial</td>
    <td style="background-color: var(--partial-bg); width: 40px;"></td>
    <td style="background-color: var(--partial-border); width: 40px;"></td>
