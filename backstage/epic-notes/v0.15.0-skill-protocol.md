...
flowchart TB
    ...
    classDef default fill:#f5f5f5,stroke:#999,stroke-width:2px
    classDef approved fill:#C8E6C9,stroke:#388E3C,stroke-width:2px
    classDef blocker fill:#FFCDD2,stroke:#D32F2F,stroke-width:2px
    classDef developed fill:#BBDEFB,stroke:#1976D2,stroke-width:2px
    classDef developed+ fill:#FFE082,stroke:#F57C00,stroke-width:2px
    classDef partial fill:#E1BEE7,stroke:#7B1FA2,stroke-width:2px
```
...
|---|------|-------|------|------------------------|
| 1 | █ | █ | **default** | No agreement yet. Backlog, not discussed, not approved. |
| 2 | █ | █ | **approved** | Agreed by all stakeholders, ready for development. Sometimes has notes. |
| 3 | █ | █ | **blocker** | Either needs discussion to agree, OR failed implementation. **Always with numbered note.** |
| 4 | █ | █ | **developed** | Agreed and implemented. Ready for testing. |
| 5 | █ | █ | **developed+** | Agreed and implemented, but developer (AI) made decisions that warrant discussion. |
| 6 | █ | █ | **partial** | Node works, but some paths (arrows) fail. **Use arrow colors to show which paths work vs fail.** |
