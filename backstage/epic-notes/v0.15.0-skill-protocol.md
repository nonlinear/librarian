...
.labelBkg {
  opacity: 1 !important;
  background-color: var(--node-border) !important;
...
.edgeLabel foreignObject {
  fill: var(--node-border) !important;
...
/* Force ALL paths inside node groups */
...
flowchart TB
    ...
    linkStyle 3 stroke:var(--approved-border),stroke-width:3px
```
