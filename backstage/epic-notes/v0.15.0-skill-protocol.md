...
flowchart TB
    ...
    TRIGGER --> METADATA["👷 Load metadata _1_"]:::approved
    METADATA --> CHECK{"👷 Metadata exists?"}:::approved
    
    CHECK -->|No| ERROR["🎤 🤚 No metadata found:<br>Run librarian index _5_"]:::blocker
    CHECK -->|Yes| INFER{"🎤 Infer scope? _2_"}:::approved
    
    INFER -->|confidence lower than 75%| CLARIFY["🎤 🤚 Say it again? _5_"]:::blocker
    INFER -->|confidence higher than 75%| BUILD["👷 Build command _3_"]:::approved
    
    BUILD --> CHECK_SYSTEM{"⚙️ System working?"}:::approved
    
    CHECK_SYSTEM -->|No| BROKEN["🎤 🤚 System is broken _5_"]:::blocker
    ...
    CHECK_RESULTS -->|No| EMPTY["🎤 🤚 No results found _5_"]:::blocker
