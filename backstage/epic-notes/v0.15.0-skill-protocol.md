...
| Name | bg | border | Meaning |
|------|-----|--------|---------|
| .node | Gray | Dark gray | Base node style (not implemented yet) |
| .approved | Yellow | Dark yellow | Correct behavior (hard stops, error handling) |
| .blocker | Red | Dark red | Broken, needs fixing |
| .developed | Blue | Dark blue | Implemented and working |
