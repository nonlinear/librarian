...
flowchart TD
    ...
    CHECK -->|NO| ERROR(["*⚠️ No metadata found: Run librarian index* 4️⃣"])
    CHECK -->|YES| INFER{"Infer scope? 2️⃣"}
    
    INFER -->|"confidence lower than 75%"| CLARIFY(["Ask clarification 6️⃣"])
    CLARIFY --> TRIGGER
    ...
    CHECK_RESULTS -->|NO| EMPTY(["*No results found for this query*"])
    ...
    style RESPONSE fill:#E0E0E0,stroke:#9E9E9E,color:#000
