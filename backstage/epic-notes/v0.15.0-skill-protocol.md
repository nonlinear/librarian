...
```mermaid
flowchart TB
    TRIGGER(["🎤 Trigger + context<br/>✅ Works"]):::developed
    ...
    INFER -->|confidence higher than 75%| BUILD(["👷 Build command _3_<br/>✅ Created"]):::developed
...
**State progression:**
- default → developed (when implemented)
- default → blocker (when broken/discovered issues)
- blocker → developed (when fixed)
